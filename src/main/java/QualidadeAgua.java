public enum QualidadeAgua {
    //Ref. http://www.cuidedosrios.eco.br/qualidade-das-aguas/
    ...
    MUITO_POLUIDA("Muito poluída"),
    //7. Extremamente poluída / Fora de Classe / Cor indicatória: roxo (AIQA > 1,20)
    EXTREMAMENTE_POLUIDA("Extremamente poluída"),
    ;
    private String qualidade;

    QualidadeAgua(String qualidade){
